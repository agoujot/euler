open List
let t = [8; 2; 22; 97; 38; 15; 0; 40; 0; 75; 4; 5; 7; 78; 52; 12; 50; 77; 91; 8;
		 ...
		 04; 52; 08; 83; 97; 35; 99; 16; 7; 97; 57; 32; 16; 26; 26; 79; 33; 27; 98; 66;
...
let rec d (x, m, j) =
	...
	then m
		...
		| 0 -> if  (x mod 20 < 17) && ((nth t x) * (nth t (x+1)) * (nth t (x+2)) * (nth t (x+3)) > m)
